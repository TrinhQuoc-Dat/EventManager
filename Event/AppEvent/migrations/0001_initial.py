    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_ticket', models.CharField(default='normal', max_length=20)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='AppEvent.event')),
            ],
            options={
                'ordering': ['-id'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='AppEvent.user')),
            ],
            options={
