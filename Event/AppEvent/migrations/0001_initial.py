# Generated by Django 5.1.6 on 2025-03-25 14:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='AppEvent.category')),
            ],
            options={
                'ordering': ['-id'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='AppEvent.user')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='AppEvent.payment')),
                ('ticket_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='AppEvent.ticket')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='AppEvent.user')),
            ],
            options={
